...
<html data-wf-page="6044f3166ba35f858102dc85" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_01_end</title>
  <meta content="task_01_end" property="og:title">
  <meta content="task_01_end" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      ...
      <p class="paragraph-9">Très bien ! Vous avez résolu la tâche 1 correctement.</p>
      <div class="div-block-7">
        <a href="{{ route("task2") }}" class="button w-button">À la prochaine tâche</a>
      </div>
    </div>
  </main>
