...
<html data-wf-page="6044f3166ba35f235f02dc7d" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_02</title>
  <meta content="task_02" property="og:title">
  <meta content="task_02" property="twitter:title">
  ...
  sessionStorage.setItem('startZeit2', timeInfo);
  </script>

  <script>
  //Script für Clickzähler
  if (sessionStorage.getItem("clickCount2") === null) {
  sessionStorage.setItem("clickCount2", "0");}
  ...
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      ...
      <div class="div-block-7">
        <a href="{{ route("index") }}" class="button w-button">Commencer la tâche 2</a>
      </div>
    </div>
  </main>
