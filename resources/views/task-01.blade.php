...
<html data-wf-page="6044f3166ba35f72ad02dc7c" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_01</title>
  <meta content="task_01" property="og:title">
  <meta content="task_01" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Aufgabe 1</h1>
      <p class="paragraph-9">Von einer Bekannten haben Sie gehört, wie wohltuend die Aroma-Sauna im Freizeit-Zentrum Mundial ist. Sie möchten sich gerne nächste Woche selber davon überzeugen. <br>Finden Sie mit der Mundial-Webseite heraus, ob die Aroma-Sauna im Winter geöffnet ist. </p>
      <div class="div-block-7">
        <a href="{{ route("index") }}" class="button w-button">Aufgabe 1 beginnen</a>
      </div>
    </div>
  </main>
