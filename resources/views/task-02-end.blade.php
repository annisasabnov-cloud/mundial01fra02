...
<html data-wf-page="6044f3166ba35f2a1e02dc86" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_02_end</title>
  <meta content="task_02_end" property="og:title">
  <meta content="task_02_end" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Succès</h1>
      <p class="paragraph-9">Très bien ! Vous avez résolu la tâche 2 correctement.</p>
      <div class="div-block-7">
        <a class="button w-button" onclick="window.close()">Rétour au questionnaire</a>
      </div>
    </div>
  </main>
