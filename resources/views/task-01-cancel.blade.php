...
<html data-wf-page="6044f3166ba35f091b02dc8b" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_01_cancel</title>
  <meta content="task_01_cancel" property="og:title">
  <meta content="task_01_cancel" property="twitter:title">
      ...
      <div class="div-block-7">
        <div>
          <div class="w-layout-grid grid-2">
            ...
            <a href="{{ route("task2") }}" class="button-red-abbrechen w-button">Ja, überspringen</a>
          </div>
        </div>
      </div>
    </div>
