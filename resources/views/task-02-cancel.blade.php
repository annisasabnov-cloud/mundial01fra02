...
<html data-wf-page="6044f3166ba35fbfd002dc8c" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_02_cancel</title>
  <meta content="task_02_cancel" property="og:title">
  <meta content="task_02_cancel" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Sauter la tâche</h1>
      <p class="paragraph-9">Vous êtes sûr de vouloir sauter cette tâche ?</p>
      <div class="div-block-7">
        <div>
          <div class="w-layout-grid grid-2">
            <a href="{{ route("index") }}" class="button3 w-button">Non, rétour</a>
            <a onclick='location.href="{{ route("backToUnipark") }}"' class="button-red-abbrechen w-button">Oui, sauter</a>
  ...
  <!-- [if lte IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/placeholders/3.0.2/placeholders.min.js"></script><![endif] -->
                     ...
                     <script type="text/javascript">
                         function sendToDatabase() {
                           ...
                           sessionStorage.setItem('endZeit2', timeInfo);

                           var language = "DE";
                           var usability = "high";
                           var tasknumber = 2;

                           var start = sessionStorage.getItem('startZeit2');
                           var end = sessionStorage.getItem('endZeit2');
                           var nbClick = sessionStorage.getItem('clickCount2');
                           var lfdn = sessionStorage.getItem('lfdn');
                           var success = "fail";


                           $.ajax({
                             type: "POST",
                             url: "/mundial01dea02/sendToDatabaseFail.php",
                             data: {
                               'language': language,
                               'usability': usability,
                             ...
                             //console.log('erfolgreich', data, textStatus)
                             window.location.href="https://uxpadawan.ch/mundial01dea03/back-to-unipark.html";
                           }).fail(function (jqXHR, textStatus, errorThrown) {
                             //alert("Fehler beim Speichern: " + textStatus);
                           });
                         }
                       </script>
