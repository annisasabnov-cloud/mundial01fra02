...
<html data-wf-page="6044f3166ba35f395502dc7a" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>reservation_geburtstag_complete</title>
  <meta content="reservation_geburtstag_complete" property="og:title">
  <meta content="reservation_geburtstag_complete" property="twitter:title">
  ...
  <main id="main-content" class="main-content">
    ...
    <div data-collapse="tiny" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
      <div class="container-6 w-container">
        ...
        <x-language-selector />
        <a href="{{ route("aufgabe") }}" class="button-task-header w-button">AUFGABE</a>
...
function showPage() {
  ...
  document.getElementById("myDiv").style.display = "block";
      ...
      <script>
         setTimeout(function(){
            window.location.href = 'https://mundial-de.webflow.io/task-01-end';
         }, 2000);
      </script>
    </body>
    </html>
