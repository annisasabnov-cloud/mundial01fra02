...
<html data-wf-page="6044f3166ba35f235402dc82" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
...
<body class="body">
  ...
  <div class="w-container">
    <div class="div-block-37">{!! trans_db('angebote2.card02.step', null, '2. Titulaire de la carte') !!}</div>
  </div>
  <div class="container-7 w-container">
    ...
    <p class="paragraph-16">{!! trans_db('angebote2.card02.instruction', null, "Veuillez indiquer le prénom, le nom de famille et l'âge du titulaire de la carte") !!}</p>
    <div class="w-form">
      <div class="contact-form-grid">
        <div id="w-node-f79050e4-9a7f-c7fa-683e-88258bf55c82-5402dc82"><label for="Vorname" id="contact-first-name">{!! trans_db('angebote2.card02.first_name', null, 'Prénom *') !!}</label><input type="text" maxlength="256" name="Vorname" data-name="Vorname" id="Vorname" class="w-input"></div>
        <div id="w-node-f79050e4-9a7f-c7fa-683e-88258bf55c86-5402dc82"><label for="Nachname" id="contact-last-name">{!! trans_db('angebote2.card02.last_name', null, 'Nom de famille *') !!}</label><input type="text" maxlength="256" name="Nachname" data-name="Nachname" id="Nachname" class="w-input"></div>
        <div id="w-node-f79050e4-9a7f-c7fa-683e-88258bf55c8a-5402dc82"><label for="Alter" id="contact-email">{!! trans_db('angebote2.card02.age', null, 'Âge *') !!}</label><input type="number" class="w-input" maxlength="256" name="Alter" data-name="Alter" id="Alter" required=""></div>

        <div id="formInstructions" class="small-text w-node-f79050e4-9a7f-c7fa-683e-88258bf55c8e-5402dc82"><em>{!! trans_db('angebote2.card02.required_fields', null, '* Champs obligatoires') !!}<br>‍</em></div>
      </div>
      <div class="div-block-40">
        <div class="div-block-150"></div>
      </div>
      <div class="prozentanzeige01">
        <div class="text-block-6">2/4</div>
      </div>
      <div class="w-layout-grid grid-2">
        <a href="{{ route("angebote2.kaufMundialcard01") }}" class="secondary-abbrechen-button w-button">{!! trans_db('angebote2.card.back_btn', null, 'Rétour') !!}</a><a href="{{ route("angebote2.kaufMundialcard03") }}" class="primary-weiter-button w-button">{!! trans_db('angebote2.card.next', null, 'Suivant') !!}</a>
        </div>
      <div class="w-form-done">
        <div>Thank you! Your submission has been received!</div>
      </div>
