...
<html data-wf-page="6044f3166ba35f6a1602dc7b" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>start</title>
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Aufgaben</h1>
      <p class="paragraph-9">Sie werden nun <strong>3 Aufgaben </strong>mit der Webseite des Freizeit-Zentrums Mundial machen. <br>‍<br>Sie können jederzeit mit dem <strong>grünen Button &quot;Aufgabe&quot;</strong> die Aufgabenstellung nachlesen. <br>‍<br>Falls Sie eine Aufgabe <strong>nicht lösen</strong> können, können Sie sie dort auch <strong>überspringen</strong>. <br>‍</p>
      <div class="div-block-7">
        <a href="{{ route("task1") }}" class="button w-button">Aufgaben starten</a>
      </div>
    </div>
  </main>
