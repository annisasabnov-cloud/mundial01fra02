...
<html data-wf-page="6044f3166ba35f594102dc8d" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_03_cancel</title>
  <meta content="task_03_cancel" property="og:title">
  <meta content="task_03_cancel" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Aufgabe überspringen</h1>
      <p class="paragraph-9">Sind Sie sicher, dass Sie die Aufgabe überspringen möchten?</p>
      <div class="div-block-7">
        <div>
          <div class="w-layout-grid grid-2">
            <a href="{{ route("index") }}" class="button3 w-button">Nein, zurück</a>
            <a href="{{ route("backToUnipark") }}" class="button-red-abbrechen w-button">Ja, überspringen</a>
          </div>
        </div>
      </div>
    </div>
