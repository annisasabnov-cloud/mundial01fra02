...
<html data-wf-page="6044f3166ba35fed8202dc87" data-wf-site="6044f3166ba35f926402dc6b">
<head>
  <meta charset="utf-8">
  <title>task_03</title>
  <meta content="task_03" property="og:title">
  <meta content="task_03" property="twitter:title">
...
<body>
  <main id="main-content" class="main-content">
    ...
    <div class="container-9 w-container">
      <h1 class="heading-10">Aufgabe 3</h1>
      <p class="paragraph-9">Sie haben bald Geburtstag und möchten Ihre <strong>fünf besten Freunde</strong> für einen Bowling-Abend im Freizeit-Zentrum Mundial einladen. Reservieren Sie für Donnerstagabend nächster Woche eine Bahn für 19:00 Uhr. <br><br><strong>Hinweis 1:</strong> Sie trinken gerne Bier.<br><strong>Hinweis 2:</strong> Sie müssen nicht Ihre persönlichen Daten eingeben, sondern können etwas erfinden. <br></p>
      <div class="div-block-7">
        <a href="{{ route("index") }}" class="button w-button">Aufgabe 3 beginnen</a>
      </div>
    </div>
  </main>
